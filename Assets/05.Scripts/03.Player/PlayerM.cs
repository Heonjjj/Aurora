...
public interface IPlayer //참조하는이들이 내부구조 몰라도됨, 테스트또는 몬스터등 재사용가능
{
...
public sealed class PlayerM : IPlayer
{
    ...
    public float CriticalDamage { get; private set; } // 기본 1.5배 = 1.5f
    public int AbilityATK { get; private set; }
    public int AbilityDEF { get; private set; }
    public int Penetration { get; private set; } // 방어 무시 수치 
    public float StaminaRegenRate { get; private set; } // 초당 회복량

    public event Action<int> OnLevelUp;

    //매개변수로받아야 유닛마다 다른 초기값을 줄수있음
    public PlayerM(
